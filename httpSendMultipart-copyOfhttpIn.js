module.exports = function(RED) {
    ...
    function createRequestWrapper(node,req) {
        ...
        toWrap.forEach(function(f) {
            if (typeof req[f] === "function") {
                wrapper[f] = function() {
                    node.warn(RED._("httpSendMultipart.errors.deprecated-call",{method:"msg.req."+f}));
    ...
    function createResponseWrapper(node,res) {
        ...
        toWrap.forEach(function(f) {
            wrapper[f] = function() {
                node.warn(RED._("httpSendMultipart.errors.deprecated-call",{method:"msg.res."+f}));
    ...
    function HTTPIn(n) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            if (!n.url) {
                this.warn(RED._("httpSendMultipart.errors.missing-path"));
                return;
            }
            this.url = n.url;
            ...
            this.warn(RED._("httpSendMultipart.errors.not-created"));
        }
    }
    RED.nodes.registerType("httpSendMultipart",HTTPIn);
}
